...
altair_form_adv = {
    ...
    // date range
    date_range: function () {
        var FromDates = document.getElementsByClassName("dpFromDate");
        var EndDates = document.getElementsByClassName("dpEndDate");
        for (var i = 0; i < FromDates.length; i++) {


            var $dp_start = $('#' + FromDates[i].id),
                $dp_end = $('#' + EndDates[i].id);
